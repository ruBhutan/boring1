  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Hero Brand Colors
        'hero-emerald': '#34d399', // emerald-400 from "Bhutan's Magic" gradient
        'hero-amber': '#fbbf24',   // amber-400 from "Bhutan's Magic" gradient
        'hero-highlight': '#34d399', // emerald-400 from "Gross National Happiness"
        'hero-btn-from': '#059669', // emerald-600 from button gradient
        'hero-btn-to': '#047857',   // emerald-700 from button gradient
        chart: {
          "1": "var(--chart-1)",
          "2": "var(--chart-2)",
          "3": "var(--chart-3)",
